  ...
  const handleGenerateSpeech = async () => {
    ...
    try {
      const response = await fetch('https://large-text-to-speech.p.rapidapi.com/tts', {
        method: 'POST',
        headers: {
          'x-rapidapi-key': '0b9a1fb45emshca06d87d000fd5ap1594fajsn06c0e24c81bc',
      ...
      const audioFileUrl = result.audio_url; // Adjust based on API response
